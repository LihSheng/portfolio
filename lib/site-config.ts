...
export const siteConfig: SiteConfig = {
  ...
  author: {
    ...
    bio: 'I’m a software developer with 5+ years of experience building web applications, enterprise systems, and data-driven products.',
    social: {
