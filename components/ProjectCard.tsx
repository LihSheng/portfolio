  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <h3
            className="text-xl font-bold text-gray-900 dark:text-black mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200"
